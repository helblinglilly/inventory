...
ALTER TABLE `recipe_ingredient` ALTER COLUMN "quantity" TO "quantity" real NOT NULL DEFAULT 1;--> statement-breakpoint
...
ALTER TABLE `shopping_list_entry` ALTER COLUMN "quantity" TO "quantity" real NOT NULL DEFAULT 1;